...
## 🗂️ Supported Models & Draft Registry

The registry maps verified targets to their optimized DFlash draft models. If a target is registered, `dflash-mlx` loads the appropriate draft automatically:
